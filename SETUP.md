...
stale rows on screen. Fullscreen TUI keeps its configured behavior. Set
`OPENPI_WINDOWS_TUI_COMPAT=0` before starting Pi to opt out of this
Windows-only adjustment.
